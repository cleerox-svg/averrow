// Feed Failures, v3 treatment for /admin/metrics-v3.
//
// Significant data-shape overlap with /feeds-v3 — both render a
// per-feed view with verdict + failure stats. Decision: keep this
// tab as a FOCUSED 24h triage view distinct from /feeds-v3:
//
...
export function FeedFailuresV3() {
...
function FeedRiskDetail({ row }: { row: FeedFailureRow }) {
  return (
    <Card variant="elevated" className="p-4 col-span-full">
      ...
      >
        Open in /feeds-v3 for full detail + actions
...
//
// Unique to this view — /feeds-v3 only shows last_error per feed.
