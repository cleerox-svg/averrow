...
| `agent_outputs` | Agent execute() bodies | API, briefing, narrator | Per-agent insights / diagnostics. AI-generated content. Type column: `score`, `correlation`, `insight`, `diagnostic`. |
